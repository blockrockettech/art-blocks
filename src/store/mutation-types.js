...
export const SET_ACCOUNT_TOKEN_DETAILS = 'SET_ACCOUNT_TOKEN_DETAILS';
export const SET_SAC_DETAILS = 'SET_SAC_DETAILS';
...
export const SET_ARTIST_CONTRACT_DETAILS = 'SET_ARTIST_CONTRACT_DETAILS';
